  ...
  return {
    ...
    execute: function () {
      ...
      _export("printLog", printLog = (_dec = ccclass('printLog'), _dec2 = property(Label), _dec(_class = (_class2 = class printLog extends Component {
        ...
        start() {
          // 获取已保存的对话事件对象
          const dialogData = (_crd && dialogLocalData === void 0 ? (_reportPossibleCrUseOfdialogLocalData({
            error: Error()
          }), dialogLocalData) : dialogLocalData).getSysLocalAboutDialog(); // 将对象转换为格式化的 JSON 字符串

          const formattedData = JSON.stringify(dialogData, null, 2); // 显示在 Label 上
...
//# sourceMappingURL=8d278f09e55cb2ae0fb36c3eeaa7322f04ad5754.js.map