      ...
      _export("settingData", settingData = (_dec = ccclass('settingData'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Prefab), _dec(_class = (_class2 = class settingData extends Component {
        ...
        loadScene(sceneName) {
          ...
          if (director.getScene().name === sceneName) {
            if (sys.localStorage.getItem(sceneName)) {
              ...
              let sceneData = new Map(JSON.parse(sys.localStorage.getItem(sceneName)));
        ...
        changeStateValue(type, value) {
          ...
          if (find('Canvas/Camera/状态UI')) {
            let 状态UI = find('Canvas/Camera/状态UI').getComponent(_crd && stateUI === void 0 ? (_reportPossibleCrUseOfstateUI({
              error: Error()
            }), stateUI) : stateUI);
            console.log(状态UI);
        ...
        currentScene() {
          ...
          if (sys.localStorage.getItem('openState')) {
            const openState = JSON.parse(sys.localStorage.getItem('openState'));
          ...
          const currentSceneName = currentScene == null ? void 0 : currentScene.name;
          ...
          if (currentSceneName != 'End' && currentSceneName != 'setting' && currentSceneName != 'startMenu') {
            ...
            const autoSave = JSON.parse(sys.localStorage.getItem('autoSave'));
...
//# sourceMappingURL=63c25c517e65836cf3e5112559c2be132eaee81d.js.map