      ...
      _export("mezi", mezi = (_dec = ccclass('mezi'), _dec2 = property({
        ...
        pressEvent() {
          if (this.node.parent.name == 'content') {
            ...
            let PlayerNode = find((_crd && PlayerLocal === void 0 ? (_reportPossibleCrUseOfPlayerLocal({
              error: Error()
            }), PlayerLocal) : PlayerLocal).PlayerPath);
            console.log(PlayerNode.getPathInHierarchy(), 'Playeryyy');

            if (PlayerNode) {
              let PlayerScript = PlayerNode.getComponent(_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
                error: Error()
              }), Player) : Player);
            ...
            switch (this.interactionEvent) {
              ...
              case (_crd && interactionEvent === void 0 ? (_reportPossibleCrUseOfinteractionEvent({
                ...
                if (this.isDialog == true) {
                  let galgame = prefab.getComponent(_crd && dialog_galgame === void 0 ? (_reportPossibleCrUseOfdialog_galgame({
                    error: Error()
        ...
        start() {
          ...
          this.node.on(Node.EventType.TOUCH_END, event => {
            if (this.node.parent.name == 'content') {
              let parentBag = this.node.parent.getComponent(_crd && bag === void 0 ? (_reportPossibleCrUseOfbag({
                error: Error()
        ...
        onDestroy() {
          ...
          if (this.node.parent.name == 'content') {
            if (this.isFood == true) {
              if (find('data')) {
                let data = find('data').getComponent(_crd && settingData === void 0 ? (_reportPossibleCrUseOfsettingData({
                  error: Error()
...
//# sourceMappingURL=665ab0d1c2602f6252a3ccb1a14d2534d5d56f91.js.map