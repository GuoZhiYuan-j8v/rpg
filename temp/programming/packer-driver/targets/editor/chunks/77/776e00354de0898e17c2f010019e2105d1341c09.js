  ...
  return {
    ...
    execute: function () {
      ...
      _export("move", move = (_dec = ccclass('move'), _dec2 = property(Node), _dec(_class = (_class2 = class move extends Component {
        ...
        enterWord() {
          let tangmianScript = this.word.getComponent(_crd && tangmian === void 0 ? (_reportPossibleCrUseOftangmian({
            error: Error()
          }), tangmian) : tangmian);
...
//# sourceMappingURL=776e00354de0898e17c2f010019e2105d1341c09.js.map