          ...
          for (let i = 0; i < this.questionNodeParent.children.length; i++) {
            if (this.question.position.x == this.questionNodeParent.children[i].position.x) {
              if (this.node.angle == 0 && this.question.position.y < this.questionNodeParent.children[i].position.y) {
                tween(this.question).to(0.5, {
                  position: this.questionNodeParent.children[i].position
                }).delay(0.5).call(() => {
                  this.questionNodeParent.children[i].getComponent(_crd && interaction === void 0 ? (_reportPossibleCrUseOfinteraction({
                    error: Error()
...
//# sourceMappingURL=40d0483f6a8415a0e76477b28c5d914bf17c2ec1.js.map