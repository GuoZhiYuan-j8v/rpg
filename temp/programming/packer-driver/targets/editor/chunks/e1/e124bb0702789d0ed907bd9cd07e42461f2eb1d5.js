        ...
        interactionContactFunction() {
          ...
          if (this.启用条件 == false) {
            ...
            this.inventroy.forEach((value, index) => {
              let bagScript = find('Canvas/Camera/bag/view/content').getComponent(_crd && bag === void 0 ? (_reportPossibleCrUseOfbag({
                error: Error()
              }), bag) : bag);
...
//# sourceMappingURL=e124bb0702789d0ed907bd9cd07e42461f2eb1d5.js.map