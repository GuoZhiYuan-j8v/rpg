    ...
    execute: function () {
      ...
      _export("chair", chair = (_dec = ccclass('chair'), _dec(_class = class chair extends (_crd && interaction === void 0 ? (_reportPossibleCrUseOfinteraction({
        ...
        interactionContactFunction() {
          ...
          var worldPos = this.node.getComponent(UITransform).convertToWorldSpaceAR(v3(0, -9.1));
          var localPos = find('Canvas/2.5d/Player').parent.getComponent(UITransform).convertToNodeSpaceAR(worldPos);
...
//# sourceMappingURL=16527aa64a809098e4e465ab585fc42b01342f7d.js.map