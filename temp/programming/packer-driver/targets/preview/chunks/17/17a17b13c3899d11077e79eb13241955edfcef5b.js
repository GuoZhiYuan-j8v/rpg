  ...
  return {
    ...
    execute: function () {
      ...
      _export("bag", bag = (_dec = ccclass('bag'), _dec(_class = class bag extends Component {
        ...
        checkHas(meziName, count) {
          if (count === void 0) {
            count = 1;
          }

          var foundCount = 0; // 用于计数找到的物品数量
        ...
        setDefultPos() {
          for (var children of this.node.children) {
        ...
        load() {
          if (sys.localStorage.getItem('lnventory')) {
            var lnventory = Object.assign(new Array(), JSON.parse(sys.localStorage.getItem('lnventory')));
            console.log(lnventory);

            for (var i = 0; i < lnventory.length; i++) {
...
//# sourceMappingURL=17a17b13c3899d11077e79eb13241955edfcef5b.js.map