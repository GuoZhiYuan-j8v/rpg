        ...
        start() {
          ...
          this.node.on(Node.EventType.TOUCH_START, event => {
            resources.load('map/介绍', Prefab, (err, res) => {
              ...
              var introductionScript = prefab.getComponent(_crd && introduction === void 0 ? (_reportPossibleCrUseOfintroduction({
                error: Error()
...
//# sourceMappingURL=c0480accaf9a278b8d7718226087dbe615fa8d8d.js.map